...
let earThreshold = parseFloat(sensitivity?.value ?? '0.25');
// disable visual/audio drowsiness alert and overlays by default
const showDrowsinessAlert = false;

// Lower thresholds make the demo trigger earlier when the driver feels sleepy.
// This helps match the intended “lazy/drowsy” alert behavior in the browser demo.
...
function onResults(results){
  ...
  if (consecCounter >= triggerFrames){
    // do not show the alert when alerts are turned off
